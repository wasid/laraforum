...
Route::group(array('prefix' => '/forum'), function(){
			...
			Route::post('/search', array('before' => 'csrf', 'uses' => 'ForumController@search', 'as' => 'forum-search'));
			...
			Route::group(array('before' => 'auth'), function(){
				...
				Route::get('/comment/show/{id}', array('uses' => 'ForumController@showComment', 'as' => 'forum-show-comment'));
				Route::get('/thread/show/{id}', array('uses' => 'ForumController@showeditThread', 'as' => 'forum-showedit-thread'));

				Route::group(array('before' => 'csrf'), function(){

					Route::post('/thread/{id}/new', array('uses' => 'ForumController@storeThread', 'as' => 'forum-store-thread'));
					Route::put('/thread/{id}/edit', array('uses' => 'ForumController@editThread', 'as' => 'forum-edit-thread'));
					Route::post('/comment/{id}/new', array('uses' => 'ForumController@storeComment', 'as' => 'forum-store-comment'));
					Route::put('/comment/{id}/edit', array('uses' => 'ForumController@editComment', 'as' => 'forum-edit-comment'));
...
Route::group(array('before' => 'auth'), function(){
			...
			Route::get('/user/change-password', array('uses' => 'UserController@getChangePassword', 'as' => 'getChangepassword'));	

			Route::get('/user/{id}', array('uses' => 'UserController@getProfile', 'as' => 'getProfile'));

			Route::group(array('before' => 'csrf'), function(){

			Route::post('/user/change-password', array('uses' => 'UserController@postChangePassword', 'as' => 'postChangepassword'));
